...
export const MANUAL_ENTRIES: ManualQuickEntry[] = [
  ...
  },
  {
    ...
    steps: ["Selecione o cliente ou mantenha Consumidor Padrão para venda à vista.", "Digite produto ou código; informe quantidade no formato 2*produto.", "Revise preço, desconto e disponibilidade.", "Escolha a condição permitida; cliente padrão só aceita À vista.", "Use Enter para seguir Desconto → Condição → Observação → Finalizar.", "Finalize e encaminhe o pedido ao Caixa quando houver pagamento."],
    shortcuts: "Ctrl+K pesquisa; Enter adiciona; F1 imprimir; F2 visualizar; F3 finalizar; F5 limpar; F6 cliente; F8 orçamentos.", cautions: "O backend bloqueia crédito sem aprovação, desconto acima da alçada, estoque insuficiente e recebimento pelo vendedor.", audit: "Venda, desconto, autorização, estoque e recebimento ficam vinculados ao usuário autenticado."
  },
  {
  ...
  },
  {
    ...
    steps: ["Crie ou localize o produto.", "Preencha dados gerais e variações com SKU/EAN.", "Configure estoque por depósito, fornecedores, conversões e preços.", "Revise completude e perfil fiscal.", "Salve e teste a pesquisa no Catálogo/PDV."], cautions: "Não reutilize SKU/EAN; alterações fiscais exigem revisão responsável.", audit: "Alterações cadastrais, importações, etiquetas e status de cadastro ficam registradas."
  },
  {
