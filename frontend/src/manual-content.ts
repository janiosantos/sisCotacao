...
export const MANUAL_ENTRIES: ManualQuickEntry[] = [
  ...
  },
  {
    ...
    shortcuts: "Ctrl+K pesquisa; leitor+Enter adiciona e prepara a próxima leitura; F1 imprimir; F2 visualizar; F3 finalizar; F5 limpar; F6 cliente; F8 orçamentos.", cautions: "Se um código estiver vinculado a mais de um produto, escolha o item na lista; o backend bloqueia crédito sem aprovação, desconto acima da alçada, estoque insuficiente e recebimento pelo vendedor.", audit: "Venda, desconto, autorização, estoque e recebimento ficam vinculados ao usuário autenticado."
  },
  {
