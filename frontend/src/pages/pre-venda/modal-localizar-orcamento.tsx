// pages/pre-venda/modal-localizar-orcamento.tsx — localizar orçamento rascunho no PDV.
import { useEffect, useState } from "react";
import { api, type OrcamentoLista } from "../../api/client";
import { fmtDate, fmtMoney } from "../../ui/format";
import { SearchModal } from "../../ui/search-modal";

export function ModalLocalizarOrcamento({ onClose, onSelecionar }: { onClose: () => void; onSelecionar: (id: number) => void }) {
