...
export const MANUAL_ENTRIES: ManualQuickEntry[] = [
  ...
  },
  {
    ...
    steps: ["Pesquise por nome, descrição, marca, sinônimo ou qualquer código; a consulta administrativa inclui rascunhos, itens em revisão, publicados e bloqueados.", "Use os filtros encadeados Grupo → Subgrupo → Categoria → Subcategoria para restringir a lista.", "Em Edição rápida, percorra as células com Tab, marque linhas e aplique um status coletivo; revise o destaque amarelo antes de salvar.", "No editor completo, preencha os dados gerais e abra a aba Códigos para cadastrar EAN/GTIN, código interno, do fabricante, fornecedor ou embalagem.", "Configure estoque por depósito, fornecedores, conversões e preços.", "Revise completude e perfil fiscal antes de publicar."], cautions: "Não reutilize SKU/EAN. A grade salva o lote inteiro ou não salva nenhuma linha; se outra pessoa alterar um item, recarregue antes de tentar novamente. Categoria e subcategoria devem respeitar o grupo e subgrupo selecionados.", audit: "A edição rápida registra o lote e o responsável; importações, etiquetas e mudanças de status também ficam registradas."
  },
  {
  ...
  },
  {
    ...
    steps: ["Crie a categoria informando obrigatoriamente o grupo e o subgrupo correspondentes.", "Adicione subcategorias quando necessário.", "Use o seletor de subgrupo para corrigir categorias antigas sem vínculo; os produtos acompanham a nova cadeia.", "Revise produtos de todos os status antes de excluir ou reclassificar.", "Use a árvore para localizar itens."], cautions: "Evite categorias duplicadas e confirme a mudança de subgrupo, pois ela reclassifica os produtos vinculados.", audit: "Criação, alteração, exclusão e reclassificação ficam vinculadas ao usuário."
  },
  {
