// FichaClientes.tsx — modal "Ficha de Clientes" (padrão Protheus), em React.
...
function SearchGlyph() {
  return <span style={{ color: "#555", fontSize: 14, lineHeight: 1 }}>⌕</span>;
}
    ...
    <LegacyModalShell
      ...
      footer={
        <ModalFooterButtons
          onConfirm={handleConfirm}
          onCancel={onClose}
          confirmRef={registerRef("confirmarBtn") as never}
          cancelRef={registerRef("cancelarBtn") as never}
          confirmTabIndex={16}
          cancelTabIndex={17}
        />
      }
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <FieldBox label="Tipo Pessoa" width={210}>
            <select
              ref={registerRef("tipoPessoa") as never}
              tabIndex={4}
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <FieldBox label="Situação" width={190} noBorderLeft>
            <select
              ref={registerRef("situacao") as never}
              tabIndex={15}
