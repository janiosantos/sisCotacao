"""Provedor EfiPay — boleto e PIX (FASE 2, reservado).

Implementação prevista para a fase 2 (requer certificado P12/PEM e OAuth2
client credentials). Enquanto não implementado, os métodos lançam erro claro
para não serem usados por engano.
"""
...
class EfiPayProvider(PaymentProvider):
    ...
    def _nao_implementado(self):
        raise NotImplementedError(
            "EfiPay está previsto para a fase 2 (exige certificado digital). "
