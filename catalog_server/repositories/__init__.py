...
from catalog_server.repositories.fiscal import cfop_repo, cst_repo, fiscal_config_repo
...
from catalog_server.repositories.precos import promocao_repo, revisao_repo, tabela_preco_repo
