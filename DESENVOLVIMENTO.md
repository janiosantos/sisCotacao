...
- **34 testes frontend** (era 13) + typecheck/build verdes; client HTTP com cache curto, invalidação após mutações e validação runtime mínima no catálogo; `parseBusca` do PDV e preservação de foco do Modal cobertos por testes.
